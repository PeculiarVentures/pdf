...
FormComponentRegistry.register(FormComponentType.radioButtonGroup, RadioButtonGroup as typeof FormComponentGroup);
FormComponentRegistry.register(FormComponentType.signatureBox, SignatureBox);
FormComponentRegistry.register(FormComponentType.signatureBoxGroup, SignatureBoxGroup as typeof FormComponentGroup);
