...
export class TextEditorHandler implements ITextEditorHandler {
  ...
  public static readonly BACKGROUND_COLOR = 1;
  public static readonly BORDER_WIDTH = 1;
  public static readonly BORDER_COLOR = 0;
  ...
  public drawText(
    ...
    let formContent = form
      ...
      .fillColor(params.backgroundColor || TextEditorHandler.BACKGROUND_COLOR)
      .fill();
    ...
    if (borderWidth > 0) {
      formContent = formContent
        ...
        .strokeColor(params.borderColor || TextEditorHandler.BORDER_COLOR)
        .stroke();
    }
